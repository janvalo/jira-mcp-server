    ...
    try {
        switch (name) {
            case "create_jira_task":
                return await jiraClient.createTask(args);
            case "update_jira_task_status":
                return await jiraClient.updateTaskStatus(args);
            case "update_jira_task_progress":
                return await jiraClient.updateTaskProgress(args);
            case "get_jira_task":
                return await jiraClient.getTask(args);
            case "list_jira_tasks":
                return await jiraClient.listTasks(args);
            default:
